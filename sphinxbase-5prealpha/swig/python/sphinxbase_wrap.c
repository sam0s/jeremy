...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_FrontEnd", _wrap_new_FrontEnd, METH_VARARGS, (char *)"new_FrontEnd(fe_t * ptr) -> FrontEnd"},
	 ...
	 { "FrontEnd_start_utt", _wrap_FrontEnd_start_utt, METH_VARARGS, (char *)"FrontEnd_start_utt(FrontEnd self)"},
	 { "FrontEnd_process_utt", _wrap_FrontEnd_process_utt, METH_VARARGS, (char *)"FrontEnd_process_utt(FrontEnd self, int16 const * spch, size_t nsamps, mfcc_t *** cep_block) -> int32"},
	 { "FrontEnd_end_utt", _wrap_FrontEnd_end_utt, METH_VARARGS, (char *)"FrontEnd_end_utt(FrontEnd self, mfcc_t * out_cepvector) -> int32"},
	 { "FrontEnd_swigregister", FrontEnd_swigregister, METH_VARARGS, NULL},
	 { "new_Feature", _wrap_new_Feature, METH_VARARGS, (char *)"new_Feature(feat_t * ptr) -> Feature"},
	 ...
	 { "FsgModel_trans_add", _wrap_FsgModel_trans_add, METH_VARARGS, (char *)"FsgModel_trans_add(FsgModel self, int32 src, int32 dst, int32 logp, int32 wid)"},
	 { "FsgModel_null_trans_add", _wrap_FsgModel_null_trans_add, METH_VARARGS, (char *)"FsgModel_null_trans_add(FsgModel self, int32 src, int32 dst, int32 logp) -> int32"},
	 { "FsgModel_tag_trans_add", _wrap_FsgModel_tag_trans_add, METH_VARARGS, (char *)"FsgModel_tag_trans_add(FsgModel self, int32 src, int32 dst, int32 logp, int32 wid) -> int32"},
	 { "FsgModel_add_silence", _wrap_FsgModel_add_silence, METH_VARARGS, (char *)"FsgModel_add_silence(FsgModel self, char const * silword, int32 state, float silprob) -> int"},
	 ...
	 { "JsgfRule_fromIter", _wrap_JsgfRule_fromIter, METH_VARARGS, (char *)"JsgfRule_fromIter(jsgf_rule_iter_t * itor) -> JsgfRule"},
	 { "JsgfRule_name", _wrap_JsgfRule_name, METH_VARARGS, (char *)"JsgfRule_name(JsgfRule self) -> char const *"},
	 { "JsgfRule_public", _wrap_JsgfRule_public, METH_VARARGS, (char *)"JsgfRule_public(JsgfRule self) -> bool"},
	 { "JsgfRule_swigregister", JsgfRule_swigregister, METH_VARARGS, NULL},
	 { "NGramModel_fromIter", _wrap_NGramModel_fromIter, METH_VARARGS, (char *)"NGramModel_fromIter(ngram_model_set_iter_t * itor) -> NGramModel"},
	 { "new_NGramModel", _wrap_new_NGramModel, METH_VARARGS, (char *)"\n"
		"NGramModel(char const * path)\n"
		"new_NGramModel(Config config, LogMath logmath, char const * path) -> NGramModel\n"
		""},
	 { "delete_NGramModel", _wrap_delete_NGramModel, METH_VARARGS, (char *)"delete_NGramModel(NGramModel self)"},
	 { "NGramModel_write", _wrap_NGramModel_write, METH_VARARGS, (char *)"NGramModel_write(NGramModel self, char const * path, ngram_file_type_t ftype)"},
	 { "NGramModel_str_to_type", _wrap_NGramModel_str_to_type, METH_VARARGS, (char *)"NGramModel_str_to_type(NGramModel self, char const * str) -> ngram_file_type_t"},
	 { "NGramModel_type_to_str", _wrap_NGramModel_type_to_str, METH_VARARGS, (char *)"NGramModel_type_to_str(NGramModel self, int type) -> char const *"},
	 { "NGramModel_casefold", _wrap_NGramModel_casefold, METH_VARARGS, (char *)"NGramModel_casefold(NGramModel self, int kase)"},
	 { "NGramModel_size", _wrap_NGramModel_size, METH_VARARGS, (char *)"NGramModel_size(NGramModel self) -> int32"},
	 { "NGramModel_add_word", _wrap_NGramModel_add_word, METH_VARARGS, (char *)"NGramModel_add_word(NGramModel self, char const * word, float32 weight) -> int32"},
	 { "NGramModel_add_class", _wrap_NGramModel_add_class, METH_VARARGS, (char *)"NGramModel_add_class(NGramModel self, char const * c, float32 w, size_t n, float32 const * weights) -> int32"},
	 { "NGramModel_prob", _wrap_NGramModel_prob, METH_VARARGS, (char *)"NGramModel_prob(NGramModel self, size_t n) -> int32"},
	 { "NGramModel_swigregister", NGramModel_swigregister, METH_VARARGS, NULL},
	 { "new_LogMath", _wrap_new_LogMath, METH_VARARGS, (char *)"\n"
		"LogMath()\n"
		"new_LogMath(logmath_t * ptr) -> LogMath\n"
		""},
	 { "delete_LogMath", _wrap_delete_LogMath, METH_VARARGS, (char *)"delete_LogMath(LogMath self)"},
	 { "LogMath_exp", _wrap_LogMath_exp, METH_VARARGS, (char *)"LogMath_exp(LogMath self, int prob) -> float64"},
	 { "LogMath_swigregister", LogMath_swigregister, METH_VARARGS, NULL},
	 { "NGramModelSetIterator_ptr_set", _wrap_NGramModelSetIterator_ptr_set, METH_VARARGS, (char *)"NGramModelSetIterator_ptr_set(NGramModelSetIterator self, ngram_model_set_iter_t * ptr)"},
	 { "NGramModelSetIterator_ptr_get", _wrap_NGramModelSetIterator_ptr_get, METH_VARARGS, (char *)"NGramModelSetIterator_ptr_get(NGramModelSetIterator self) -> ngram_model_set_iter_t *"},
	 { "new_NGramModelSetIterator", _wrap_new_NGramModelSetIterator, METH_VARARGS, (char *)"new_NGramModelSetIterator(ngram_model_set_iter_t * ptr) -> NGramModelSetIterator"},
	 { "delete_NGramModelSetIterator", _wrap_delete_NGramModelSetIterator, METH_VARARGS, (char *)"delete_NGramModelSetIterator(NGramModelSetIterator self)"},
	 { "NGramModelSetIterator_next", _wrap_NGramModelSetIterator_next, METH_VARARGS, (char *)"NGramModelSetIterator_next(NGramModelSetIterator self) -> NGramModel"},
	 { "NGramModelSetIterator___next__", _wrap_NGramModelSetIterator___next__, METH_VARARGS, (char *)"NGramModelSetIterator___next__(NGramModelSetIterator self) -> NGramModel"},
	 { "NGramModelSetIterator_swigregister", NGramModelSetIterator_swigregister, METH_VARARGS, NULL},
	 { "JsgfIterator_ptr_set", _wrap_JsgfIterator_ptr_set, METH_VARARGS, (char *)"JsgfIterator_ptr_set(JsgfIterator self, jsgf_rule_iter_t * ptr)"},
	 { "JsgfIterator_ptr_get", _wrap_JsgfIterator_ptr_get, METH_VARARGS, (char *)"JsgfIterator_ptr_get(JsgfIterator self) -> jsgf_rule_iter_t *"},
	 { "new_JsgfIterator", _wrap_new_JsgfIterator, METH_VARARGS, (char *)"new_JsgfIterator(jsgf_rule_iter_t * ptr) -> JsgfIterator"},
	 ...
	 { "NGramModelSet___iter__", _wrap_NGramModelSet___iter__, METH_VARARGS, (char *)"NGramModelSet___iter__(NGramModelSet self) -> NGramModelSetIterator"},
	 { "new_NGramModelSet", _wrap_new_NGramModelSet, METH_VARARGS, (char *)"new_NGramModelSet(Config config, LogMath logmath, char const * path) -> NGramModelSet"},
	 { "delete_NGramModelSet", _wrap_delete_NGramModelSet, METH_VARARGS, (char *)"delete_NGramModelSet(NGramModelSet self)"},
	 { "NGramModelSet_count", _wrap_NGramModelSet_count, METH_VARARGS, (char *)"NGramModelSet_count(NGramModelSet self) -> int32"},
	 { "NGramModelSet_add", _wrap_NGramModelSet_add, METH_VARARGS, (char *)"NGramModelSet_add(NGramModelSet self, NGramModel model, char const * name, float weight, bool reuse_widmap) -> NGramModel"},
	 { "NGramModelSet_select", _wrap_NGramModelSet_select, METH_VARARGS, (char *)"NGramModelSet_select(NGramModelSet self, char const * name) -> NGramModel"},
	 { "NGramModelSet_lookup", _wrap_NGramModelSet_lookup, METH_VARARGS, (char *)"NGramModelSet_lookup(NGramModelSet self, char const * name) -> NGramModel"},
	 { "NGramModelSet_current", _wrap_NGramModelSet_current, METH_VARARGS, (char *)"NGramModelSet_current(NGramModelSet self) -> char const *"},
	 { "NGramModelSet_swigregister", NGramModelSet_swigregister, METH_VARARGS, NULL},
	 ...
	 { "Jsgf_name", _wrap_Jsgf_name, METH_VARARGS, (char *)"Jsgf_name(Jsgf self) -> char const *"},
